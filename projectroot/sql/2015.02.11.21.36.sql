...
insert  into `staff`(`staff_id`,`thumbnail_url`,`name_prefix`,`name_first`,`name_middle`,`name_last`,`name_suffix`,`position`,`email`,`contact_number`) values (1,NULL,'Engr.','Juan','Mercedez','Cebedo','Jr.','Engineer','mercedez@gmail.com','0922-611-0429'),(12,NULL,'Pref','First','Mid','Last','Suf','Pos','testpos@gmail.com','0927-961-9650');
...
insert  into `tasks`(`task_id`,`content`,`date_start`,`date_end`,`project_id`,`staff_id`,`team_id`,`status`) values (9,'12','2012-12-12','2012-12-12',14,1,3,1),(10,'Testing','2012-02-22','2022-02-22',11,12,7,0);
