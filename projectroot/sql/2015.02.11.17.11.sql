...
insert  into `assignments_field`(`project_id`,`field_id`,`label`,`value`) values (11,1,'BIR','12345');
...
insert  into `projects`(`project_id`,`thumbnail_url`,`name`,`type`,`status`,`location`,`notes`) values (14,NULL,'test',0,0,'','');
...
insert  into `staff`(`staff_id`,`thumbnail_url`,`name_prefix`,`name_first`,`name_middle`,`name_last`,`name_suffix`,`position`) values (12,NULL,'Pref','First','Mid','Last','Suf','Pos');
...
insert  into `tasks`(`task_id`,`content`,`date_start`,`date_end`,`project_id`,`staff_id`,`team_id`,`status`) values (8,'Testing','2012-12-12','2012-12-12',11,1,7,0);
