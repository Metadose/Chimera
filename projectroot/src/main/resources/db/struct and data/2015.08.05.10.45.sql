...
insert  into `assignments_project_field`(`project_id`,`field_id`,`label`,`value`) values (108,1,'Test Label Test Label','Test');
...
insert  into `assignments_project_staff`(`project_id`,`staff_id`) values (108,79),(108,80),(108,81),(108,82),(108,89),(108,90);
...
insert  into `milestones`(`milestone_id`,`name`,`description`,`project_id`,`company_id`) values (1,'Prepare',NULL,108,4),(2,'Do it',NULL,108,4),(3,'Test',NULL,108,4);
...
insert  into `projects`(`project_id`,`thumbnail_url`,`name`,`type`,`status`,`location`,`notes`,`company_id`) values (108,NULL,'Brown Building',0,0,'Rizal Avenue, Dipolog City','This is a test project.',4);
...
insert  into `tasks`(`task_id`,`title`,`content`,`date_start`,`duration`,`project_id`,`status`,`company_id`,`milestone_id`) values (1,'Task 1','Test','2015-01-10',20,108,1,4,1),(2,'Task 2','Test','2015-01-30',5,108,0,4,1),(3,'Task 3','Test','2015-02-04',15,108,0,4,2),(4,'Task 4','Test','2015-02-19',15,108,0,4,2),(5,'Task 5','Test','2015-03-06',30,108,0,4,3);
