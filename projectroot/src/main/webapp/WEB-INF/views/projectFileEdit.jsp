	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<!-- Content Header (Page header) -->
	        <section class="content-header">
	            <h1>
	                ${projectFile.name}
	                <small>${action} ProjectFile</small>
	            </h1>
	            <ol class="breadcrumb">
	                <li><a href="${contextPath}/dashboard/">Home</a></li>
	                <li><a href="${contextPath}/projectFile/list">ProjectFile</a></li>
	                <li class="active">${projectFile.name}</li>
	            </ol>
	        </section>
                                	...
                                	<div class="row">
                   						<div class="col-md-6">
                   							<div class="box box-primary">
                   								...
                   								<div class="box-body">
                   									<form role="form" name="detailsForm" id="detailsForm" method="post" action="${contextPath}/projectFile/create">
				                                        <div class="form-group">
				                                        	<input type="hidden" name="id" value="${projectFile.id}"/>
				                                            <label>Name</label>
				                                            <input type="text" class="form-control" name="name" value="${projectFile.name}"/><br/>
				                                        </div>
				                                    </form>
				                                    <c:choose>
		                                            	...
		                                            	<c:when test="${projectFile.id > 0}">
		                                            		...
		                                            		<a href="${contextPath}/projectFile/delete/${projectFile.id}">
																<button class="btn btn-danger btn-sm">Delete This ProjectFile</button>
															</a>
		                                            	</c:when>
		                                            </c:choose>
                   								</div>
              						...
              						<div class="row">
                   						<div class="col-md-6">
                   							<div class="box box-primary">
                   								<div class="box-header">
                   									<h3 class="box-title">ProjectFiles</h3>
                   								</div>
                   								<div class="box-body">
                   									<table>
                   										<tr style="padding-bottom: 5px">
                   											...
                   											<td>
                   												...
                   												<button class="btn btn-info btn-sm" style="padding: 3px; margin-bottom: 3px">View ProjectFile</button>
                   											</td>
                   										</tr>
                   										<tr>
                   											<td>
													...
													<br/>
													<br/>
													<h4>Assign More ProjectFiles</h4>
													<table>
														<tr>
															<td style="padding-right: 3px;">
															...
															<td style="padding-bottom: 3px;">
																<select class="form-control">
					                                                ...
					                                                <option>Costing ProjectFile</option>
					                                            </select>
															</td>
														</tr>
													</table>
		                            ...
		                            <ul class="timeline">
		                                ...
		                                <li>
		                                    ...
		                                    <div class="timeline-item">
		                                        ...
		                                        <h3 class="timeline-header"><a href="#">Support ProjectFile</a> sent you and email</h3>
