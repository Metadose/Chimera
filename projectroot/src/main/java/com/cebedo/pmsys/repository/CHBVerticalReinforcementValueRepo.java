...
public class CHBVerticalReinforcementValueRepo implements
	IValueRepository<CHBVerticalReinforcement> {

    private RedisTemplate<String, CHBVerticalReinforcement> redisTemplate;

    public void setRedisTemplate(
	    RedisTemplate<String, CHBVerticalReinforcement> redisTemplate) {
    ...
    @Override
    public void set(CHBVerticalReinforcement obj) {
    ...
    @Override
    public List<CHBVerticalReinforcement> multiGet(Collection<String> keys) {
