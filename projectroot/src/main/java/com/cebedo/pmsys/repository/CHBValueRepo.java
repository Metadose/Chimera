...
public class CHBValueRepo implements IValueRepository<CHB> {

    private RedisTemplate<String, CHB> redisTemplate;

    public void setRedisTemplate(RedisTemplate<String, CHB> redisTemplate) {
    ...
    @Override
    public List<CHB> multiGet(Collection<String> keys) {
