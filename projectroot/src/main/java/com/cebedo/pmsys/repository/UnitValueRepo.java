...
public class UnitValueRepo implements IValueRepository<Unit> {

    private RedisTemplate<String, Unit> redisTemplate;

    public void setRedisTemplate(RedisTemplate<String, Unit> redisTemplate) {
    ...
    @Override
    public List<Unit> multiGet(Collection<String> keys) {
