...
public class PlasterMixtureValueRepo implements
	IValueRepository<PlasterMixture> {

    private RedisTemplate<String, PlasterMixture> redisTemplate;

    public void setRedisTemplate(
	    RedisTemplate<String, PlasterMixture> redisTemplate) {
    ...
    @Override
    public void set(PlasterMixture obj) {
    ...
    @Override
    public List<PlasterMixture> multiGet(Collection<String> keys) {
