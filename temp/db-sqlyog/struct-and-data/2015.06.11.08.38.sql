...
insert  into `assignments_project_manager`(`project_id`,`staff_id`,`project_position`) values (72,62,'Project Manager'),(72,63,''),(72,64,'');
...
insert  into `assignments_project_team`(`project_id`,`team_id`) values (72,29),(72,30);
...
insert  into `assignments_staff_team`(`staff_id`,`team_id`) values (62,29),(63,29),(63,30),(64,30);
...
insert  into `projects`(`project_id`,`thumbnail_url`,`name`,`type`,`status`,`location`,`notes`,`company_id`) values (72,NULL,'ABC Boys Building',0,0,'Rizal Avenue, Dipolog City','This is a test project.',4),(73,NULL,'qqweqw',0,0,'eqweqwe','qweqwe',4);
...
insert  into `teams`(`team_id`,`name`,`payroll_type`,`company_id`) values (29,'Quality Assurance',1,4),(30,'QA Team',2,4);
