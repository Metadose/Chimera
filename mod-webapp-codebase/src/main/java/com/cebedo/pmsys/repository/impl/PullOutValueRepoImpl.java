...
public class PullOutValueRepoImpl implements IValueRepository<PullOut> {

    private RedisTemplate<String, PullOut> redisTemplate;

    public void setRedisTemplate(RedisTemplate<String, PullOut> redisTemplate) {
    ...
    @Override
    public List<PullOut> multiGet(Collection<String> keys) {
