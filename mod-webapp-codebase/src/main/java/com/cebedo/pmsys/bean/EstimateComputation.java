...
public class EstimateComputation implements Serializable {
    ...
    private List<TypeEstimate> estimateTypes = new ArrayList<TypeEstimate>();
    ...
    public EstimateComputation() {
	;
    }

    public EstimateComputation(Project proj) {
	setCompany(proj.getCompany());
	setProject(proj);
    }

    public boolean willComputeConcrete() {
	return this.estimateTypes.contains(TypeEstimate.CONCRETE);
    }

    public boolean willComputeMasonryCHB() {
	return this.estimateTypes.contains(TypeEstimate.MASONRY_CHB);
    }

    public boolean willComputeMasonryBlockLaying() {
	return this.estimateTypes.contains(TypeEstimate.MASONRY_BLOCK_LAYING);
    }

    public boolean willComputeMasonryPlastering() {
	return this.estimateTypes.contains(TypeEstimate.MASONRY_PLASTERING);
    }

    public boolean willComputeMasonryCHBFooting() {
	return this.estimateTypes.contains(TypeEstimate.MASONRY_CHB_FOOTING);
    }

    public boolean willComputeMRCHB() {
	return this.estimateTypes.contains(TypeEstimate.METAL_REINFORCEMENT_CHB);
    }

    public boolean willComputeMRIndependentFooting() {
	return this.estimateTypes.contains(TypeEstimate.METAL_REINFORCEMENT_INDEPENDENT_FOOTING);
    }

    public boolean willComputeMRPostColumn() {
	return this.estimateTypes.contains(TypeEstimate.METAL_REINFORCEMENT_POST_COLUMN);
    }
    ...
    public List<TypeEstimate> getEstimateTypes() {
	return estimateTypes;
    }

    public void setEstimateTypes(List<TypeEstimate> estimateTypes) {
    ...
    public EstimateResultMRIndependentFooting getResultMRIndependentFooting() {
	return resultMRIndependentFooting;
    }
