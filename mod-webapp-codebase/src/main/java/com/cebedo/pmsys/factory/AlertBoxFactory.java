...
/**
 * TODO Need to clean up this class.<br>
 * Implement object-oriented way, and design patterns.
 */
public class AlertBoxFactory {

    public static AlertBoxFactory SUCCESS = new AlertBoxFactory(ConstantsSystem.UI_STATUS_SUCCESS);
    public static AlertBoxFactory FAILED = new AlertBoxFactory(ConstantsSystem.UI_STATUS_DANGER);
    public static String ERROR = new AlertBoxFactory(ConstantsSystem.UI_STATUS_DANGER,
